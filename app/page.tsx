...
export default function Home() {
  ...
  function updateCell(person: Person, day: number, target: 'cells' | 'ot', code: string, closeAfter = false) {
    ...
    if (closeAfter) setPick(null);
  }

  function clearPickCell(person: Person, day: number) {
    const id = cellId(person.id, day);
    const nextCells = { ...plan.cells };
    const nextOt = { ...plan.ot };
    delete nextCells[id];
    delete nextOt[id];
    save({ ...plan, cells: nextCells, ot: nextOt });
    setPick(null);
  }
